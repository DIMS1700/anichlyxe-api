              ...
              <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3 animate-in fade-in slide-in-from-bottom-4 duration-500">
                 {activeAnimeList.map((anime) => (
                    <Link 
                       to={`/detail/${anime.id}`} 
                       key={anime.id}
                       className="group relative bg-[#18181b] rounded-xl overflow-hidden border border-white/5 hover:border-violet-500/40 transition-all duration-300 hover:shadow-lg hover:shadow-violet-500/10"
                    >
                       <div className="aspect-[3/4] overflow-hidden relative">
                          ...
                          <div className="absolute top-1.5 right-1.5">
                             <div className="flex items-center gap-1 px-1.5 py-0.5 bg-black/70 backdrop-blur-sm border border-white/10 rounded text-[9px] font-bold text-violet-300">
                                <Clock size={8} />
                          ...
                          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-200 scale-75 group-hover:scale-100">
                             <div className="w-8 h-8 bg-violet-600 rounded-full flex items-center justify-center shadow-lg text-white">
                       ...
                       <div className="absolute bottom-0 left-0 right-0 p-2.5">
                          <h3 className="text-white text-xs font-bold leading-tight line-clamp-2 mb-1 group-hover:text-violet-400 transition-colors">
                             {anime.title}
                          </h3>
